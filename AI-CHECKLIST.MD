...
2. **Create a report** at `security/reports/{CATEGORY}_REPORT.md` documenting exactl![alt text](image.png)y what you found: what's vulnerable, what's safe, what's missing entirely, and severity (CRITICAL / HIGH / MEDIUM / LOW / PASS).
