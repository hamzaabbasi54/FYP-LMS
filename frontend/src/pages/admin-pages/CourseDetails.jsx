            ...
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-start justify-between gap-6">
                        ...
                        <div className="flex flex-row md:flex-col gap-4 bg-slate-50 p-5 rounded-xl border border-slate-100 min-w-[200px]">
                            <div>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
                    ...
                    {clos.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            {clos.map((clo, index) => (
                                <div key={clo.id || index} className="group relative bg-white border border-slate-200 rounded-xl p-5 hover:border-indigo-300 hover:shadow-md transition-all">
