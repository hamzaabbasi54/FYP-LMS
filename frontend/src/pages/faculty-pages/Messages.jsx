                            ...
                            filteredContacts.map(contact => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-3 px-4 py-3.5 text-left transition-all border-b border-slate-200/50 hover:bg-slate-100/50 ${isActive ? 'bg-sky-50/80 border-l-4 !border-l-sky-500' : ''
                                            }`}
                                    >
                                        {/* Avatar */}
                                                ...
                                                <React.Fragment key={msg.id || idx}>
                                                    ...
                                                    <div className={`flex ${isMine ? 'justify-end' : 'justify-start'} ${isConsecutive ? 'mt-0.5' : 'mt-3'}`}>
                                                        <div className={`max-w-[75%] ${isMine ? 'order-1' : 'order-1'}`}>
                                                            <div className={`px-3.5 py-2 rounded-3xl text-sm leading-relaxed shadow-sm ${isMine
